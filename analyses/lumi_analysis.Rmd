...
---
title: "POrigins of the concepts cause, cost, and goal in prereaching infants"
author: "Shari Liu"
date: "Dec 10, 2018"
output:
...
```{r fig2cow, fig.width = 20, include=TRUE}


# avg looks to eff and ineff, grouped by experiment, with full variable info 
fig2.exp1 <- ggplot(data = dplyr::filter(lumi.raw.avg, experiment=="Exp.1"), aes(type, look)) +
  geom_boxplot(outlier.colour = NA, alpha = .8)+
  stat_summary(fun.y = mean, geom = "point", shape=21, size=3, position = "dodge", colour = "red", fill = "red") +
  ylab("Looking Time (s)") +
  xlab("Test Event")+
  ...
  geom_point(alpha = 0.1)+
  geom_line(alpha = 0.1, aes(group = subj_id))+
  geom_errorbar(data = filter(summary.avg, paper == "LBS" & experiment=="Exp.1"), size = 1, width = 0, colour = "red", aes(ymin=look-ci, ymax=look+ci)) +
  scale_x_discrete(labels = c("efficient","inefficient"))+
  # theme_bw(14)+
  facet_grid(~experiment+goal+hab+causal+mitten+stimuli)+
  scale_fill_brewer(palette="Greys")+
...
fig2.exp2 <- ggplot(data = dplyr::filter(lumi.raw.avg, experiment=="Exp.2"), aes(type, look)) +
  geom_boxplot(outlier.colour = NA, alpha = .8)+
  stat_summary(fun.y = mean, geom = "point", shape=21, size=3, position = "dodge", colour = "red", fill = "red") +
  ylab("Looking Time (s)") +
  xlab("Test Event")+
  ...
  geom_point(alpha = 0.1)+
  geom_line(alpha = 0.1, aes(group = subj_id))+
  geom_errorbar(data = filter(summary.avg, paper == "LBS" & experiment=="Exp.2"), size = 1, width = 0, colour = "red", aes(ymin=look-ci, ymax=look+ci)) +
  scale_x_discrete(labels = c("efficient","inefficient"))+
  # theme_bw(14)+
  facet_grid(~experiment+goal+hab+causal+mitten+stimuli)+
  scale_fill_brewer(palette="Greys")+
...
fig2.exp3 <- ggplot(data = dplyr::filter(lumi.raw.avg, experiment=="Exp.3"), aes(type, look)) +
  geom_boxplot(outlier.colour = NA, alpha = .8)+
  stat_summary(fun.y = mean, geom = "point", shape=21, size=3, position = "dodge", colour = "red", fill = "red") +
  ylab("Looking Time (s)") +
  xlab("Test Event")+
  ...
  geom_point(alpha = 0.1)+
  geom_line(alpha = 0.1, aes(group = subj_id))+
  geom_errorbar(data = filter(summary.avg, paper == "LBS" & experiment=="Exp.3"), size = 1, width = 0, colour = "red", aes(ymin=look-ci, ymax=look+ci)) +
  scale_x_discrete(labels = c("efficient","inefficient"))+
  # theme_bw(14)+
  facet_grid(~experiment+goal+hab+causal+mitten+stimuli)+
  scale_fill_brewer(palette="Greys")+
...
fig2.exp4 <- ggplot(data = dplyr::filter(lumi.raw.avg, experiment=="Exp.4"), aes(type, look)) +
  geom_boxplot(outlier.colour = NA, alpha = .8)+
  stat_summary(fun.y = mean, geom = "point", shape=21, size=3, position = "dodge", colour = "red", fill = "red") +
  ylab("Looking Time (s)") +
  xlab("Test Event")+
  ...
  geom_point(alpha = 0.1)+
  geom_line(alpha = 0.1, aes(group = subj_id))+
  geom_errorbar(data = filter(summary.avg, paper == "LBS" & experiment=="Exp.4"), size = 1, width = 0, colour = "red", aes(ymin=look-ci, ymax=look+ci)) +
  scale_x_discrete(labels = c("efficient","inefficient"))+
  # theme_bw(14)+
  facet_grid(~experiment+goal+hab+causal+mitten+stimuli)+
  scale_fill_brewer(palette="Greys")+
...
fig2.exp5 <- ggplot(data = dplyr::filter(lumi.raw.avg, experiment=="Exp.5"), aes(type, look)) +
  geom_boxplot(outlier.colour = NA, alpha = .8)+
  stat_summary(fun.y = mean, geom = "point", shape=21, size=3, position = "dodge", colour = "red", fill = "red") +
  ylab("Looking Time (s)") +
  xlab("Test Event")+
  ...
  geom_point(alpha = 0.1)+
  geom_line(alpha = 0.1, aes(group = subj_id))+
  geom_errorbar(data = filter(summary.avg, paper == "LBS" & experiment=="Exp.5"), size = 1, width = 0, colour = "red", aes(ymin=look-ci, ymax=look+ci)) +
  scale_x_discrete(labels = c("efficient","inefficient"))+
  # theme_bw(14)+
  facet_grid(~experiment+goal+hab+causal+mitten+stimuli)+
  scale_fill_brewer(palette="Greys")+
...
plot_grid(fig2.exp1, fig2.exp2, fig2.exp3, fig2.exp4, fig2.exp5, labels = c("A", "B", "C", "D", "E"))
...
contrasts.exp2.scs <- cbind(difflsmeans(model1.exp2.scs.beta, test.effs="type:mitten")$Estimate, difflsmeans(model1.exp2.scs.cooks, test.effs="type:mitten"))
...
### Experiment 1
In the primary analysis for Experiment 1, we detected one influential participant. Including them in the sample generates the same finding as reported in the main text: Infants looked equally at the efficient vs inefficient reach of a mittened hand (`r report(exp1.findings.everyone, 2, 3, 2)`).

### Experiment 2
In the primary analysis for Experiment 2, we detected 2 influential participants. Including them in the sample generates a marginal effect in the same direction as that reported in the main text: Infants looked longer at the inefficient than the efficient reach of a bare hand (`r report(exp2.findings.everyone, 2, 3, 2)`). As stated in the main text, our overall conclusion from Experiments 1 and 2 is that infants have inconsistent, fragile expectations about the efficiency of reaches that result in displacing objects. 
