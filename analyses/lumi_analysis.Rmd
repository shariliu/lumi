...
fig2.SCS <- ggplot(data = dplyr::filter(lumi.raw.avg, paper == "SCS"), aes(type, look, fill=type))
fig2.SCS +
  ...
  geom_line(alpha = 0.3, aes(group = subj_id))+
  geom_errorbar(data = filter(summary.avg, paper == "SCS"), size = 1, width = 0, colour = "red", aes(ymin=look-ci, ymax=look+ci)) +
...
## Experiments 1-2: Prereaching infants’ understanding of reaching actions that lift objects
### Experiments 1 and 2
```{r exp1}
# participant info
