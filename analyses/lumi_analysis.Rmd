...
report <- function(table, index, places) {
  result <- paste("[", round(table$lower[index], places), ",", round(table$upper[index], places), "], ß=", round(table$beta[index], places), ", B(SE)=", round(table$b[index],places), "(", round(table$se[index],places), "), ", "p=", round(table$p[index],places), sep = "")
  return(result)
}
```
