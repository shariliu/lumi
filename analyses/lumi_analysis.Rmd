...
```{r fig2b, fig.width = 20, fig.height=13, include=TRUE}
...
In Experiment 2, we also find that infants randomly assigned to look at the efficient reach first look longer overall at test, `r report(exp2.efindings, 3, 3, 2)`.
