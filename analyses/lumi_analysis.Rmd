...
packages <- c("tidyverse", "Hmisc", "lattice", "multcomp", "lsmeans", "schoRsch", "influence.ME", "devtools", "skimr", "simr", "lme4", "sjPlot", "effects", "lmerTest", "compute.es", "pwr", "stringr", "irr", "papaja", "apastats", "predictmeans")
...
# add annotations
grid.text("Experiment", x = 0.08, y = .96)
grid.text("Training", x = 0.08, y = .91)
grid.text("Habituation", x = 0.08, y = .86)
grid.text("Goal", x = 0.08, y = 0.81)
grid.text("Mitten", x = 0.08, y = 0.76)
grid.text("Causal", x = 0.08, y = 0.71)
grid.text("Stimuli", x = 0.08, y = 0.66)
```
B.
...
fig2.prop + 
  ...
  ylab("\n \n \n \n Proportion Looking to Inefficient") +
  xlab(element_blank())+
