...
model1.exp13.ci <- gen.ci(model1.exp3)[4:6,]
...
model1.exp4.scs.ci <-  gen.ci(model1.exp4.scs) 
...
model1.all <- lmer(formula = prop.ineff.all ~ training + hab + goal + mitten + causal + (1|experiment) + (1|ageday) + (1|sex) + (1|paper), data = lumi.wide)
model1.all.table <- gen.m(model1.all)
model1.all.ci <- gen.ci(model1.all)[6:12,]

# standardized values
model1.all.beta <- lmer(formula = scale(prop.ineff.all) ~ training + hab + goal + mitten + causal + (1|experiment) + (1|ageday) + (1|sex) + (1|paper), data = lumi.wide)
...
emodel.exp1 <- lm(loglook ~ hab * type * first.test + total_hab + sex + ageday, data = exp1.avg)
emodel.exp1.table <- gen.lm(emodel.exp1)
emodel.exp1.ci <- gen.ci(emodel.exp1)

emodel.exp2 <- lm(loglook ~ type * first.test + total_hab + sex + ageday, data = exp2.avg)
emodel.exp2.table <- gen.lm(emodel.exp2)
emodel.exp2.ci <- gen.ci(emodel.exp2)

emodel.exp3 <- lm(loglook ~ causal * type * first.test + total_hab + sex + ageday, data = exp3.avg)
emodel.exp3.table <- gen.lm(emodel.exp3)
emodel.exp3.ci <- gen.ci(emodel.exp3)

emodel.exp4 <- lm(loglook ~ type * first.test + total_hab + sex + ageday, data = exp4.avg)
emodel.exp4.table <- gen.lm(emodel.exp4)
emodel.exp4.ci <- gen.ci(emodel.exp4)

emodel.exp5 <- lm(loglook ~ type * first.test + total_hab + sex + ageday, data = exp5.avg)
emodel.exp5.table <- gen.lm(emodel.exp5)
emodel.exp5.ci <- gen.ci(emodel.exp5)
```
...
`r kable(cbind(emodel.exp1.table, emodel.exp1.ci), col.names = c("Estimate (B)", "Standard Error (SE)", "t", "p", "95% CI (Lower)", "95% CI (Upper)"))`

### Experiment 2

`r kable(cbind(emodel.exp2.table, emodel.exp2.ci), col.names = c("Estimate (B)", "Standard Error (SE)", "t", "p", "95% CI (Lower)", "95% CI (Upper)"))`


### Experiment 3

`r kable(cbind(emodel.exp3.table, emodel.exp3.ci), col.names = c("Estimate (B)", "Standard Error (SE)", "t", "p", "95% CI (Lower)", "95% CI (Upper)"))`

### Experiment 4

`r kable(cbind(emodel.exp4.table, emodel.exp4.ci), col.names = c("Estimate (B)", "Standard Error (SE)", "t", "p", "95% CI (Lower)", "95% CI (Upper)"))`

### Experiment 5

`r kable(cbind(emodel.exp5.table, emodel.exp5.ci), col.names = c("Estimate (B)", "Standard Error (SE)", "t", "p", "95% CI (Lower)", "95% CI (Upper)"))`